...
class QuadCopter:
    ...
    def step(self, velocities):
        ...
        acceleration = [self.acceleration[0][0], self.acceleration[1][0], self.acceleration[2][0]]
        pos = [self.x, self.y, self.z]
        attitude = [self.phi, self.theta, self.psi]
        vel = [self.vx, self.vy, self.vz]

        return gyro, acceleration, pos, attitude, vel
